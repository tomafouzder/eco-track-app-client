    ...
    return (
        <div>
            ...
            <div className="h-full">
                <div className=" h-full flex flex-col bg-white shadow relative transition-transform duration-500 hover:scale-105">
                    ...
                    {/* Body */}
                    <div className="mt-3 p-6 flex flex-col flex-grow justify-between">
                        <h2 className="text-3xl font-bold text-green-800">{challenge.title}</h2>
                        <p className="text-gray-700 mt-4 text-sm line-clamp-2 min-h-[60px]">
                            {challenge.description
                            }
                        </p>

                        {/* Info row */}
                        <div className="my-4 flex justify-between text-gray-600 text- font-medium">
